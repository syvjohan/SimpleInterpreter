...
namespace Global {
	...
	//*****
	//HelpClass::CheckAliasNameConversion
	//*****
	...
	//*****
	//HelpClass::ReplaceDotsWithSlashes
	//*****
	...
	//*****
	//HelpClass::EvalNegativeExpression
	//*****
