...
File_s ErrorManager::files[MAXINCLUDEDFILES];
...
void ErrorManager::SetRegisteredFiles(const File_s *f, const int len) {
	memcpy(ErrorManager::files, f, len * sizeof(File_s));
