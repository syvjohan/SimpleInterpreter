...
namespace Partitioning {
	...
	//Makes it possible to call a subroutine that has been below call.
	//*****
	...
	//*****
	//Lexical::UpdateSubroutinesIndexes
	//*****
	...
	//*****
	//Lexical::TypedefSubroutinesMembers
	//*****
	...
	//*****
	//Lexical::EvalExpressionWithoutKeywords
	//*****
